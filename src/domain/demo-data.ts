...
export const createDemoState = (): AppState => ({
  ...
  routines: [
    ...
    },
    {
      ...
      scheduledTime: "11:50",
      weekdays: [0, 1, 2, 3, 4, 5, 6],
      instructions: "离开厨房前，逐项确认水龙头和灶台已经关闭。",
      confirmationQuestion: "水龙头和灶台都已经由本人确认关闭了吗？",
      graceMinutes: 10,
      familyNoticeMinutes: 10,
      enabled: true,
    },
    {
      id: "routine-night",
      ...
      scheduledTime: "22:30",
      weekdays: [0, 1, 2, 3, 4, 5, 6],
      instructions: "夜间起身先开灯，坐稳后再缓慢站起，必要时联系家属。",
      confirmationQuestion: "灯已经打开，并且准备好慢慢起身了吗？",
      graceMinutes: 15,
      familyNoticeMinutes: 10,
      enabled: true,
    },
